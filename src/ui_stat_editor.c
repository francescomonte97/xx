...
static const u8 sText_MenuTitle[] = _("Statdex 1.0       (https://l1nq.com/Min1997)");
static const u8 sText_MenuHP[] = _("PS");
static const u8 sText_MenuAttack[] = _("Att.");
static const u8 sText_MenuSpAttack[] = _("Att Sp.");
static const u8 sText_MenuDefense[] = _("Dif.");
static const u8 sText_MenuSpDefense[] = _("Dif Sp.");
static const u8 sText_MenuSpeed[] = _("Vel.");
static const u8 sText_MenuTotal[] = _("Tot.");
static const u8 sText_MenuStat[] = _("Stat");
static const u8 sText_MenuActual[] = _("Valori");
static const u8 sText_MenuEV[] = _("EV");
static const u8 sText_MenuIV[] = _("IV");
static const u8 sText_MonLevel[]= _("Lv.{CLEAR 1}{STR_VAR_1}");

static const u8 sText_MenuLRButtonTextMain[]   = _("");
static const u8 sText_MenuAButtonTextMain[]    = _("");
static const u8 sText_MenuBButtonTextMain[]    = _("");
static const u8 sText_MenuDPadButtonTextMain[] = _("");
