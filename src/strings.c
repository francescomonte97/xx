...
const u8 gText_YourName[] = _("NOME STUDENTE");
...
const u8 gText_MoveOkBack[] = _("{DPAD_NONE}MUOVI  {A_BUTTON}OK  {B_BUTTON}ESCI");const u8 gText_CallCantBeMadeHere[] = _("A call can't be made from here.");
...
const u8 gText_StatEditor[] = _("STATDEX");