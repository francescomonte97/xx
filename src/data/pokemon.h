...
const u32 gMonStillFrontPic_Torchic[] = INCBIN_U32("graphics/pokemon/foxfire/front.4bpp.lz");
const u32 gMonPalette_Torchic[] = INCBIN_U32("graphics/pokemon/foxfire/normal.gbapal.lz");
const u32 gMonBackPic_Torchic[] = INCBIN_U32("graphics/pokemon/foxfire/back.4bpp.lz");
const u32 gMonShinyPalette_Torchic[] = INCBIN_U32("graphics/pokemon/foxfire/shiny.gbapal.lz");
const u8 gMonIcon_Torchic[] = INCBIN_U8("graphics/pokemon/foxfire/icon.4bpp");
const u8 gMonFootprint_Torchic[] = INCBIN_U8("graphics/pokemon/foxfire/footprint.1bpp");
