...
const struct Tileset gTileset_albanova27x =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_albanova27x,
    .palettes = gTilesetPalettes_albanova27x,
    .metatiles = gMetatiles_albanova27x,
    .metatileAttributes = gMetatileAttributes_albanova27x,
    .callback = NULL,
};
